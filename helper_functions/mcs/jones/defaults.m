...
% WTA made edits to this file. it had some sloppy errors., like fcn == ''
% rather than strcmp(fcn,'').
function [u,v,fglob] = defaults(fcn)
global nglob xglob
...
if strcmp(fcn, 'gpr')      % Goldstein-Price
  u = [-2; -2]; 
  v = [2; 2]; 
  fglob = 3;
  xglob = [0.; -1.];
  nglob = 1;
elseif strcmp(fcn, 'bra')  % Branin
  u = [-5; 0];
  v = [10; 15]; 
  ...
  nglob = 3;  
elseif strcmp(fcn, 'cam')  % Six-hump camel
  u = [-3; -2];
  v = [3; 2]; 
  fglob = -1.0316284535;
...
-7.08350658  5.48286415  4.85805691  4.85805691 -7.08350658 -7.70831382 -1.42512845 -0.80032121 -1.42512844 -7.08350639 -7.70831354  5.48286415  5.48286415  4.85805691 -7.70831354 -0.80032121 -1.42512845 -0.80032121; 
 4.85805691  4.85805681 -7.08350658  5.48286415 -7.70831382 -7.08350658 -0.80032121 -1.42512845 -7.08350639 -1.42512844  5.48286415 -7.70831354  4.85805691  5.48286415 -0.80032121 -7.70831354 -0.80032121 -1.42512845];
  nglob = 18;
elseif strcmp(fcn, 'sh5')  % Shekel 5
  u = [0; 0; 0; 0];
  v = [10; 10; 10; 10]; 
  fglob = -10.1531996790582;
  xglob = [4; 4; 4; 4];
  nglob = 1;
elseif strcmp(fcn, 'sh7')  % Shekel 7
  u = [0; 0; 0; 0];
  v = [10; 10; 10; 10]; 
  fglob = -10.4029405668187;
  xglob = [4; 4; 4; 4];
  nglob = 1;
elseif strcmp(fcn, 'sh10')  % Shekel  % this was s10 before. WTA
  u = [0; 0; 0; 0];
  v = [10; 10; 10; 10]; 
  fglob = -10.5364098166920;
  xglob = [4; 4; 4; 4];
  nglob = 1;
elseif strcmp(fcn, 'hm3')  % Hartman 3
  u = [0; 0; 0];
  v = [1; 1; 1]; 
  fglob = -3.86278214782076;
  xglob = [0.1; 0.55592003; 0.85218259];
  nglob = 1;
elseif strcmp(fcn, 'hm6')  % Hartman 6
  u = [0; 0; 0; 0; 0; 0];
  v = [1; 1; 1; 1; 1; 1]; 
